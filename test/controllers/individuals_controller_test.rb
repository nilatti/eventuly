...
class IndividualsControllerTest < ActionController::TestCase
  ...
  test "should create individual" do
    assert_difference('Individual.count') do
      post :create, individual: { age: @individual.age, email: @individual.email, family_id: @individual.family_id, first_name: @individual.first_name, last_name: @individual.last_name }
    end
  ...
  test "should update individual" do
    patch :update, id: @individual, individual: { age: @individual.age, email: @individual.email, family_id: @individual.family_id, first_name: @individual.first_name, last_name: @individual.last_name }
    assert_redirected_to individual_path(assigns(:individual))
  end
