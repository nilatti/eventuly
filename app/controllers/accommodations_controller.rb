class AccommodationsController < ApplicationController
  ...
  def create
    @accommodation = @event.accommodations.build(accommodation_params)

    respond_to do |format|
      if @accommodation.save
        format.html { redirect_to @event, notice: 'Accommodation was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @accommodation.update(accommodation_params)
        format.html { redirect_to @event, notice: 'Accommodation was successfully updated.' }
  ...
  private
    ...
    def accommodation_params
      params.require(:accommodation).permit(:name, :max_males, :max_females, :max_neutral, :nightly_cost, :weekly_cost, :event_id)
    end
end
