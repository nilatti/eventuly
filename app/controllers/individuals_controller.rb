class IndividualsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @individual.save
        format.html { redirect_to @individual.family, notice: 'Individual was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @individual.update(individual_params)
        format.html { redirect_to @individual.family, notice: 'Individual was successfully updated.' }
  ...
  private
    ...
    def individual_params
      params.require(:individual).permit(:first_name, :last_name, :age, :email, :family_id)
    end
end
